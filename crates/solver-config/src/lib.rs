...
///
/// The purpose of this builder is to make it easier to create test configurations.
...
impl ConfigBuilder {
	...
	///
	/// Uses the values set on the builder, falling back to defaults for any unset values.
